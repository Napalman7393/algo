...
play_button_apretat = pygame.transform.scale(plat_apretat_image, ((plat_apretat_image.get_width() * 9), (plat_apretat_image.get_width() * 3)))
...
play_button_apretat_rect = play_button_apretat.get_rect(center = (amplada_pantalla // 2, altura_pantalla // 2))
